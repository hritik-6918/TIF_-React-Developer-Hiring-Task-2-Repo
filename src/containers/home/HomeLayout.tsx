      ...
      <Container maxW="1200px">
        ...
        <Tabs index={page} isLazy lazyBehavior="keepMounted">
          ...
          <Grid display="grid" gridTemplateColumns="3fr 2fr" gap="24px">
            <TabPanels>
              <TabPanel>
                <RequisitionForm handleTab={handlePage} setrequisitionDetails={setrequisitionDetails} />
              </TabPanel>
              <TabPanel>
                <JobDetailsForm handleTab={handlePage} setjobDetails={setjobDetails} />
              </TabPanel>
              <TabPanel>
                <InterviewSettingsForm handleTab={handlePage} setinterviewSettings={setinterviewSettings} />
              </TabPanel>
            </TabPanels>
